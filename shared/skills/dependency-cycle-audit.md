...
status: authored
description: Detect and break dependency cycles in a module, package, or build graph — graph extraction, SCC detection, blast-radius ranking, and the minimal cut.
---
