...
status: authored
description: Use when writing or fixing a skill's description field, or diagnosing a skill that exists but never gets used — author the description as a recognition trigger naming the situations and cue phrases that should fire it, then replay-test it against real tasks.
---
