...
status: authored
description: Extract complete, testable requirements from a vague ask — question ladders, assumption surfacing, and acceptance-criteria framing before execution scope exists.
---
