...
retired: "merged into security-threat-model — same asset-boundary-abuse-path-control-test method, fully subsumed by the survivor's STRIDE + termination floor; nothing unique lost."
status: authored
---
