...
retired: "merged into chain-construct (wired) — same compose-primitives-to-terminal-impact trigger; keep-chaining-past-critical stance + terminal-impact gate preserved here for the chain-construct wiring step."
