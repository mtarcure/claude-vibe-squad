...
| **S1** Frame (trust scope + policy) | `product-manager`, `software-supply-chain-engineer` | — | `scope-decomposition` (authored) | — |
| **S2** Design (dep graph + advisory plan) | `software-supply-chain-engineer`, `security-analyst` | — | `dependency-cycle-audit` (authored) | — |
