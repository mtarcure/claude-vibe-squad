...
| **S1** Frame (goals + level) | `learning-coach` | — | `scope-decomposition` (authored) | — |
| **S3** Produce (plan + drills + path) | `learning-coach`, `summarizer` | `chrono-vault` (all · yes · subscription) | `scope-decomposition` (authored) | — |
