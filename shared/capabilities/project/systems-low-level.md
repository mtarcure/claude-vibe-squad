...
| **S1** Frame (target / arch spec) | `product-manager`, `systems-engineer` | — | `requirements-elicitation` (authored), `scope-decomposition` (authored) | — |
| **S2** Design (arch / ABI / SIMD plan) | `architect`, `systems-engineer` | `context7` (claude · lane-live · subscription) | `dependency-cycle-audit` (authored) | — |
