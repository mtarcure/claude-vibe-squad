...
| **S1** Frame (question + source plan) | `research` | `chrono-vault` (all · yes · subscription) | `scope-decomposition` (authored) | privacy overlay if the topic involves personal data |
| **S2** Design (research strategy) | `research`, `synthesizer` | — | `scope-decomposition` (authored) | — |
