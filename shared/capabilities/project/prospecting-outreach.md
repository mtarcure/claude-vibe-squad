...
| **S1** Frame (ICP + targets + goals) | `research`, `growth-and-search-analyst`, `finance-analyst` | `chrono-research-arsenal` (all · lane-live · subscription) | `scope-decomposition` (authored) | privacy overlay (prospect PII) |
