...
| **S1** Frame (audit scope + cost) | `product-manager`, `mac-ops`, `finance-analyst` | — | `scope-decomposition` (authored) | — |
| **S2** Design (risk grouping + plan) | `architect`, `refactor-cleaner`, `agentops` | — | `refactor-scope-bounding` (stub), `dependency-cycle-audit` (authored) | — |
