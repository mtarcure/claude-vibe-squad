...
| **S6** Ship/Deliver (report) | `technical-writer`, `security-analyst` | `chrono-obsidian` | `citation-audit` | public disclosure gate |
...
`experimental-attacker` emits broad/novel
