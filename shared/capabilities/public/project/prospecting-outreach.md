...
| **S1** Frame (ICP + targets + goals) | `research`, `growth-and-search-analyst`, `finance-analyst` | `chrono-research-arsenal` | `scope-decomposition` | privacy overlay (prospect PII) |
...
| **S3** Produce (draft messages + follow-ups) | `copywriter`, `brand-voice`, `editor` | `chrono-research-arsenal` | `citation-audit` | — |
...
| **S6** Ship/Deliver (staged drafts) | `personal-ops` | `chrono-obsidian` | — | send is operator-gated (`needs_tool`); bridge is dry-run only |
