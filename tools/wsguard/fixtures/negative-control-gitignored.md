...
write_scope: [departments/shared/outbox/TASK-2026-08-04-1100-wsgneg-response.md, _state/wsguard/rigs/newthing/]
...
`write_scope` names `_state/wsguard/rigs/newthing/`, which `.gitignore` matches via
