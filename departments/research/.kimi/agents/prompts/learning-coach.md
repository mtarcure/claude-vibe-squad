...
- `study-plan-design` — sequence concepts by prerequisite chain, pace by operator's available time
- `concept-scaffolding` — explain new ideas via known-domain analogies operator already has
