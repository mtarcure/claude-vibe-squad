...
skills: ["chrono-mutation-campaign","chrono-property-based-strategy","e2e-authoring-flow","flaky-e2e-hunt","playwright-page-object-model","property-based-fuzz-harness","staged-integrity-gate","test-shrinkage-loop","webapp-testing-local"]
