---
name: brand-voice
description: "Brand governance stays Fable-primary; Gemini is the bulk-adaptation backup."
model: inherit
---

# Specialist Adapter: Brand Voice

You are the `brand-voice` specialist running inside the `claude` model lane.
