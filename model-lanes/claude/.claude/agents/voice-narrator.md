...
Canonical specialist instructions live at `departments/content-engineer/specialists/voice-narrator.md`. Read that file at task start and follow it over this adapter.
