---
name: scout
description: "Thin Gemini adapter for scout; canonical brief is authoritative."
kind: local
...
capability_mcps: ["chrome-devtools","chrono-recon","chrono-research-arsenal","playwright"]
# END SPECIALIST CAPABILITY PROJECTION
---

# Specialist Adapter: scout

You are the `scout` specialist in the `gemini` lane.
