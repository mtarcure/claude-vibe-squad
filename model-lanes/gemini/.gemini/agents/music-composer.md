---
name: music-composer
description: "Original music composition and transformation."
kind: local
...
Canonical specialist instructions live at `departments/content-engineer/specialists/music-composer.md`. Read that file at task start and follow it over this adapter.
