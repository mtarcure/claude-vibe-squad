...
description: "Thin Gemini adapter for frontend-engineer; canonical brief is authoritative."
kind: local
...
capability_mcps: ["chrome-devtools","playwright"]
# END SPECIALIST CAPABILITY PROJECTION
---

# Specialist Adapter: frontend-engineer

You are the `frontend-engineer` specialist in the `gemini` lane.
