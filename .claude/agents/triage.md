---
name: triage
description: "Classify incoming work, route to right mode/Lead, surface routing decision to Coordinator. Used inside Triage Mode and on-demand when Coordinator is uncertain where to send a task."
