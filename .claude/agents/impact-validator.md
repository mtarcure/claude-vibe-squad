...
description: "CVSS v4.0 scoring, CWE policy check, NVD/OSV calibration, duplicate detection, self-inflicted detector. Bounty Mode Phase 9."
...
- For high-severity findings (CVSS ≥ 8.0) or contested scores between the 3 model providers: dispatch `skeptic` in council mode for adversarial review (5-stance fanout) before submission.
