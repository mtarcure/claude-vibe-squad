---
name: threat-modeler
description: "Repository-grounded threat modeling — trust boundaries, abuse cases, threat-model loops. Bounty Mode Phase 3, Project Mode Phase 2 (when security-touching), on-demand."
